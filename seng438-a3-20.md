...
**Feasible du-pairs:**
du(1, 2, data), du(1, 4, data), du(1, 2, column), du(1, 4, column), du(1, 3, total), du(1, 5, total), du(4, 5, rowCount), du(4, 5, rowCount), du(2, 2, r), du(2, 3, n)
...
**testIntersectAtLowervSpecifiedRange()**, **testIntersectAboveSpecifiedRange()**, **testIntersectAtUpperSpecifiedRange()**
